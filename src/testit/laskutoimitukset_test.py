...
class TestiLaskutoimitukset(unittest.TestCase):
    ...
    def testi_peruslaskutoimitukset(self):
        ...
        self.assertEqual(self.laskutoimitukset.laske(['1', '2', '^']), 1)
        self.assertEqual(self.laskutoimitukset.laske(['1', '0', '/']), "virheellinen syöte")

    def testi_funktiot(self):
        self.assertEqual(self.laskutoimitukset.laske(['3.141592653589793', 'sin']), 0)
        self.assertEqual(self.laskutoimitukset.laske(['3.141592653589793', 'cos']), -1)
        self.assertEqual(self.laskutoimitukset.laske(['3.141592653589793', 'tan']), 0)
        self.assertEqual(self.laskutoimitukset.laske(['8', 'asin']), "virheellinen syöte")
    ...
    def testi_muuttujat(self):
        ...
        self.assertEqual(self.laskutoimitukset.laske(['z', 'x', '+']), "virheellinen syöte")
